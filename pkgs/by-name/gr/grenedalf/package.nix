...
let
  ...
  htslib_gr = htslib.overrideDerivation (oldAttrs: rec {
    ...
    configureFlags = [ "--disable-libcurl" "--disable-plugins" ];
  });
in
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    rev = "5f5f11472160a2d0317b9dc9e5f53a0afeaa922a";
    hash = "sha256-erjzT4LZuqwp5GkTR0tuQY3Qb1wLUxq6kyDW+vvZSOc=";
  ...
  meta = with lib; {
    ...
    description = "A collection of commands for working with population genetic data";
    longDescription = ''
